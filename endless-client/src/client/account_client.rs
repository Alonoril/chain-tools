...
pub trait AcctClientTrait {
    ...
    async fn balance_of(&self, owner: &AccountAddress) -> AppResult<u128>;
...
impl AcctClientTrait for EnhancedClient {
    ...
    async fn get_sequence_number(&self, account: &AccountAddress) -> AppResult<u64> {
        ...
        self.view_fn_res(args, &EdsErr::GetAcctSeqNum, None).await
    }
    ...
    async fn balance_of(&self, owner: &AccountAddress) -> AppResult<u128> {
        ...
        self.view_fn_res(args, &EdsErr::EdsBalanceOf, None).await
    }
    ...
    async fn token_balance_of(
        ...
        self.view_fn_res(args, &EdsErr::TokenBalanceOf, None).await
    }
}
